...
**Test Date:** 2025-11-19 16:25:32 UTC
**Git Commit:** 87a68204eb47473966d86ed7e06142c40bd222f4
**Branch:** dev
**Workflow Run:** [19508498984](https://github.com/VirtualFlyBrain/VFBquery/actions/runs/19508498984)
...
get_term_info (mushroom body): 1.7858s ✅
...
DEBUG: Cache lookup result: True
get_term_info (individual): 1.8243s ✅
...
DEBUG: Cache lookup result: True
NeuronsPresynapticHere: 1.6194s ✅
...
DEBUG: Cache lookup result: True
NeuronsPostsynapticHere: 1.7305s ✅
...
DEBUG: Cache lookup result: True
NeuronNeuronConnectivity: 1.5019s ✅
...
DEBUG: Cache lookup result: True
NeuronClassesFasciculatingHere: 1.3819s ✅
...
DEBUG: Cache lookup result: True
TractsNervesInnervatingHere: 1.2355s ✅
...
DEBUG: Attempting cache lookup for neuron_neuron_connectivity_query(VFB_jrchk00s) with full results
DEBUG: Cache lookup result: True
NeuronNeuronConnectivityQuery: 1.2366s ✅
...
DEBUG: Cache lookup result: True
NeuronRegionConnectivityQuery: 1.2573s ✅
...
SimilarMorphologyTo: 0.7370s ✅

================================================================================
NEURON INPUT QUERIES (Neo4j)
================================================================================
✅ Neo4j connection established
NeuronInputsTo: 3.1292s ✅

================================================================================
EXPRESSION PATTERN QUERIES (Neo4j)
================================================================================
ExpressionOverlapsHere: 0.9097s ✅
...
================================================================================
anatScRNAseqQuery: 0.7449s ✅
  └─ Found 0 total clusters
clusterExpression: 0.7505s ✅
  └─ Found 0 genes expressed
expressionCluster: 0.7430s ✅
  └─ Found 0 clusters expressing gene
scRNAdatasetData: 0.5443s ✅
  └─ Found 0 clusters in dataset

================================================================================
NBLAST SIMILARITY QUERIES
================================================================================
SimilarMorphologyTo: 0.8948s ✅
  └─ Found 227 NBLAST matches, returned 10
SimilarMorphologyToPartOf: 0.6186s ✅
  └─ Found 0 NBLASTexp matches
SimilarMorphologyToPartOfexp: 0.5956s ✅
  └─ Found 0 reverse NBLASTexp matches
SimilarMorphologyToNB: 0.7858s ✅
  └─ Found 15 NeuronBridge matches, returned 10
SimilarMorphologyToNBexp: 0.6073s ✅
...
================================================================================
PaintedDomains: 0.6405s ✅
  └─ Found 0 painted domains
DatasetImages: 0.5444s ✅
  └─ Found 0 images in dataset
AllAlignedImages: 0.5285s ✅
  └─ Found 0 aligned images
AlignedDatasets: 0.9119s ✅
...
TransgeneExpressionHere: 0.7363s ✅
...
==================================================
FBbt_00003748 query took: 1.2918 seconds
VFB_00101567 query took: 1.2630 seconds
Total time for both queries: 2.5548 seconds
...
---
*Last updated: 2025-11-19 16:25:32 UTC*

...
**Test Date:** 2025-11-18 19:35:22 UTC
**Git Commit:** a593f407651aa0c32ec181669973bd6542195799
**Branch:** dev
**Workflow Run:** [19478818130](https://github.com/VirtualFlyBrain/VFBquery/actions/runs/19478818130)
...
get_term_info (mushroom body): 2.0121s ✅
...
DEBUG: Cache lookup result: True
get_term_info (individual): 1.8787s ✅
...
DEBUG: Cache lookup result: True
NeuronsPresynapticHere: 1.4694s ✅
...
DEBUG: Cache lookup result: True
NeuronsPostsynapticHere: 1.7396s ✅
...
DEBUG: Cache lookup result: True
NeuronNeuronConnectivity: 1.3302s ✅
...
DEBUG: Cache lookup result: True
NeuronClassesFasciculatingHere: 1.2457s ✅
...
DEBUG: Cache lookup result: True
TractsNervesInnervatingHere: 1.2328s ✅
...
DEBUG: Cache lookup result: True
ListAllAvailableImages: 1.2525s ✅
...
DEBUG: Attempting cache lookup for neuron_neuron_connectivity_query(VFB_jrchk00s) with full results
DEBUG: Cache lookup result: True
NeuronNeuronConnectivityQuery: 1.4031s ✅
...
DEBUG: Cache lookup result: True
NeuronRegionConnectivityQuery: 1.3261s ✅
...
SimilarMorphologyTo: 10.9037s ✅

================================================================================
NEURON INPUT QUERIES (Neo4j)
================================================================================
NeuronInputsTo: 2.5529s ✅

================================================================================
EXPRESSION PATTERN QUERIES (Neo4j)
================================================================================
ExpressionOverlapsHere: 0.7363s ✅
...
----------------------------------------------------------------------
Ran 15 tests in 51.751s

OK
================================================================================
anatScRNAseqQuery: 0.7750s ✅
  └─ Found 0 total clusters
clusterExpression: 0.6417s ✅
  └─ Found 0 genes expressed
expressionCluster: 0.5804s ✅
  └─ Found 0 clusters expressing gene
scRNAdatasetData: 0.7631s ✅
  └─ Found 0 clusters in dataset

================================================================================
NBLAST SIMILARITY QUERIES
================================================================================
SimilarMorphologyTo: 0.8668s ✅
  └─ Found 227 NBLAST matches, returned 10
SimilarMorphologyToPartOf: 0.5979s ✅
  └─ Found 0 NBLASTexp matches
SimilarMorphologyToPartOfexp: 0.5910s ✅
  └─ Found 0 reverse NBLASTexp matches
SimilarMorphologyToNB: 0.5957s ✅
  └─ Found 15 NeuronBridge matches, returned 10
SimilarMorphologyToNBexp: 0.5814s ✅
...
================================================================================
PaintedDomains: 0.5586s ✅
  └─ Found 0 painted domains
DatasetImages: 0.5682s ✅
  └─ Found 0 images in dataset
AllAlignedImages: 0.5050s ✅
  └─ Found 0 aligned images
AlignedDatasets: 0.9263s ✅
...
TransgeneExpressionHere: 0.6707s ✅
...
VFB_00101567 query took: 1.2689 seconds
Total time for both queries: 2.6751 seconds
...
---
*Last updated: 2025-11-18 19:35:22 UTC*

...
**Test Date:** 2025-11-18 19:57:17 UTC
**Git Commit:** cc85ff5c880bfba31e5cb29f56232b14508b1511
**Branch:** dev
**Workflow Run:** [19479406377](https://github.com/VirtualFlyBrain/VFBquery/actions/runs/19479406377)
...
get_term_info (mushroom body): 1.8326s ✅
...
DEBUG: Cache lookup result: True
get_term_info (individual): 1.4985s ✅
...
DEBUG: Cache lookup result: True
NeuronsPresynapticHere: 1.4449s ✅
...
DEBUG: Cache lookup result: True
NeuronsPostsynapticHere: 1.3224s ✅
...
DEBUG: Cache lookup result: True
NeuronNeuronConnectivity: 1.6020s ✅
...
DEBUG: Cache lookup result: True
NeuronClassesFasciculatingHere: 1.1882s ✅
...
DEBUG: Cache lookup result: True
TractsNervesInnervatingHere: 1.4138s ✅
...
DEBUG: Cache lookup result: True
ListAllAvailableImages: 1.1732s ✅
...
DEBUG: Attempting cache lookup for neuron_neuron_connectivity_query(VFB_jrchk00s) with full results
DEBUG: Cache lookup result: True
NeuronNeuronConnectivityQuery: 1.1900s ✅
...
DEBUG: Cache lookup result: True
NeuronRegionConnectivityQuery: 1.1697s ✅
...
SimilarMorphologyTo: 10.6095s ✅

================================================================================
NEURON INPUT QUERIES (Neo4j)
================================================================================
NeuronInputsTo: 2.7152s ✅

================================================================================
EXPRESSION PATTERN QUERIES (Neo4j)
================================================================================
ExpressionOverlapsHere: 0.7848s ✅
...
----------------------------------------------------------------------
Ran 15 tests in 51.079s

OK
================================================================================
anatScRNAseqQuery: 0.7392s ✅
  └─ Found 0 total clusters
clusterExpression: 0.7040s ✅
  └─ Found 0 genes expressed
expressionCluster: 0.5321s ✅
  └─ Found 0 clusters expressing gene
scRNAdatasetData: 0.6721s ✅
  └─ Found 0 clusters in dataset

================================================================================
NBLAST SIMILARITY QUERIES
================================================================================
SimilarMorphologyTo: 0.8765s ✅
  └─ Found 227 NBLAST matches, returned 10
SimilarMorphologyToPartOf: 0.5720s ✅
  └─ Found 0 NBLASTexp matches
SimilarMorphologyToPartOfexp: 0.5009s ✅
  └─ Found 0 reverse NBLASTexp matches
SimilarMorphologyToNB: 0.7057s ✅
...
================================================================================
PaintedDomains: 0.6547s ✅
  └─ Found 0 painted domains
DatasetImages: 0.7474s ✅
  └─ Found 0 images in dataset
AllAlignedImages: 0.4815s ✅
  └─ Found 0 aligned images
AlignedDatasets: 0.7428s ✅
...
TransgeneExpressionHere: 0.8132s ✅
...
==================================================
FBbt_00003748 query took: 1.2797 seconds
VFB_00101567 query took: 1.2009 seconds
Total time for both queries: 2.4806 seconds
...
---
*Last updated: 2025-11-18 19:57:17 UTC*
